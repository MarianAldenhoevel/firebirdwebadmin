...
define('DEFAULT_DB',      'INTERCOMM_CMS.FDB');
define('DEFAULT_PATH',    '/db/');
define('DEFAULT_HOST',    'firebird');
define('DEFAULT_ROLE',    '');
...
define('BACKUP_DIR', '/backup'); // define this to restrict the location for backup files
